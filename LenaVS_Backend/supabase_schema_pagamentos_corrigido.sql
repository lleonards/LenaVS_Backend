-- Revisado para correção de pagamentos Stripe e sincronização de assinatura.
-- Revisado para esta entrega: sem mudanças estruturais adicionais necessárias para as correções de preview, biblioteca e exportação.
-- =========================================
