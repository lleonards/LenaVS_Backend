...
export const separateIntoStanzas = (text) => {
  ...
  if (hasBlankLines) {
    ...
    return {
      stanzas,
      autoSeparated: false,
      message: 'Letra carregada com a separação original preservada'
    };
  }
  ...
  return {
    stanzas,
    autoSeparated: false,
    message: 'Nenhuma separação automática foi aplicada; revise as estrofes manualmente se necessário'
  };
};
