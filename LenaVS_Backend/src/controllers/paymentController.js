...
const updateStripeSubscriptionState = async ({
  ...
  // Quando a assinatura é cancelada ou expirada, reverter o usuário para plano free
  // e zerar o acesso ilimitado para evitar que créditos residuais do trial sejam exibidos
  if (subscriptionStatus === 'canceled') {
    payload.plan = 'free';
    payload.unlimited_access_until = null;
    payload.credits = 0;
  }
