...
/*
  ...
  Variáveis de ambiente necessárias no servidor (Render):
    ...
    REPLICATE_DEMUCS_VERSION — (opcional) hash da versão do modelo no Replicate.
                               Padrão: modelo htdemucs mais recente (dois stems).
                               Consulte a versão mais recente em:
                               https://replicate.com/darius-wan/demucs/versions

  ──────────────────────────────────────────────────────────────────────────────
*/
const REPLICATE_API_TOKEN = process.env.REPLICATE_API_TOKEN;

// Versão padrão do modelo Demucs (htdemucs) no Replicate.
// Se esta versão estiver desatualizada, sobrescreva com a env REPLICATE_DEMUCS_VERSION.
// Link para versões: https://replicate.com/darius-wan/demucs/versions
const DEMUCS_VERSION = process.env.REPLICATE_DEMUCS_VERSION
  || '25a173108cff36ef9f80f854c162d01df9e6528b2b36a3fef10c48a34b2f83eb';
